...
namespace GameDevTV.RTS.Environment
{
    ...
    /// Types include: resource deposits, sector features, nexus connections, and climate bonuses.
    /// </summary>
    [System.Serializable]
    public class SectorNode
    {
        public enum NodeType
        {
            ...
            ClimateBonus    // One-time climate reward (temperature, atmosphere, water)
        }
