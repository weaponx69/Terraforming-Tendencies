...
* **Sector unlock colonization:** Orbital Scan / Survey Drone unlock reveals fog over that sector's reserved pads and **auto-places a Command Post** on its CP pad (`SectorColonization`). Command Post cards stay playable whenever an unlocked sector is still unclaimed (not only during expansion).
